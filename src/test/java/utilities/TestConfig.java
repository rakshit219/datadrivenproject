...
public class TestConfig{
	...
	public static String from = "coolraksi@gmail.com";
	public static String password = "mygamma62";
	public static String[] to ={"coolraksi@gmail.com","shettyrakshit1102@gmail.com"};
